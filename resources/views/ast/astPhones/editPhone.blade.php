...
@section('content')
	...
	<div class="container">
		...
		<h1 align="center">Edit Phone</h1>
		
		<hr/>
		
		{!! Form::open(['method' => 'PATCH', 'route' => ['storeEditedPhone', $astPhone->PHONE_ID]]) !!}
			...
			<div class="form-group">
				{!! Form::submit('Submit Phone and Edit Phone Parameters', ['class' => 'btn btn-primary form-control']) !!}
			</div>
